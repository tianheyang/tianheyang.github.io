 ...
 * @author Tianhe Yang, modified for tianheyang.com
 * @version 0.5
 * @date April 11, 2008
  ...
  $.fn.lightBox = function (settings) {
    ...
    settings = jQuery.extend(
      {
        ...
        imageBtnPrev: "/images/lightbox-btn-prev@2x.png", // (string) Path and the name of the prev button image
        imageBtnNext: "/images/lightbox-btn-next@2x.png", // (string) Path and the name of the next button image
      ...
      if (jQueryMatchedObj.length == 1) {
        settings.imageArray.push(
          new Array(
            ...
            objClicked.getAttribute("data-caption")
          )
        );
      } else {
        // Add an Array (as many as we have), with href and caption atributes, inside the Array that storage the images references
        for (var i = 0; i < jQueryMatchedObj.length; i++) {
          settings.imageArray.push(
            new Array(
              jQueryMatchedObj[i].getAttribute("href"),
              jQueryMatchedObj[i].getAttribute("data-caption")
            )
          );
        }
      }
    ...
    function _set_interface() {
      ...
      $("body").append(
        '<div id="jquery-overlay"></div><div id="jquery-lightbox"><div id="lightbox-container-image-box"><div id="lightbox-container-image"><img id="lightbox-image"><div style="" id="lightbox-nav"><a href="#" id="lightbox-nav-btnPrev"></a><a href="#" id="lightbox-nav-btnNext"></a></div><div id="lightbox-loading"><a href="#" id="lightbox-loading-link"><img src="' +
          ...
          '"></a></div></div></div><div id="lightbox-container-image-data"><div id="lightbox-image-details"><span id="lightbox-image-details-caption"></span><span id="lightbox-image-details-currentNumber"></span><div class="float-fix"></div></div><div id="lightbox-secNav"><a href="#" id="lightbox-secNav-btnClose"></a></div></div></div>'
      );
      // Get page sizes
    ...
    function _set_image_to_view() {
      ...
      if (settings.fixedNavigation) {
        ...
        // Hide some elements
        $(
          "#lightbox-image,#lightbox-nav,#lightbox-nav-btnPrev,#lightbox-nav-btnNext,#lightbox-container-image-data,#lightbox-image-details-currentNumber"
        ).hide();
      }
    ...
    function _show_image_data() {
      $("#lightbox-image-details").slideDown(400);
          ...
          $("#lightbox-nav-btnPrev")
            .css({
              background:
                ...
                ") left 20px top 39% / 20px no-repeat",
            })
            .unbind()
            .bind("click", function () {
          ...
          $("#lightbox-nav-btnNext")
            .css({
              background:
                ...
                ") right 20px top 39% / 20px no-repeat",
            })
            .unbind()
            .bind("click", function () {
              settings.activeImage = settings.activeImage + 1;
